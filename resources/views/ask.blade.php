                ...
                <form action="POST" >
                    ...
                    <div class="mb-[var(--margin-form)] flex items-start justify-between flex-col">
                        ...
                        <select id="category" class="text-[var(--black)] p-2 rounded-md w-full">
                            ...
                            <option value="pencil_cases">Pencil Cases & Organization</option>
                    ...
                    <div class="mb-[var(--margin-form)] flex items-start justify-between flex-col">
                        <x-form_label for="level" class="mb-[var(--margin-label)]">Grade Level</x-form_label>
                        <select name="level" id="level" class="text-[var(--black)] p-2 rounded-md w-full">
                    ...
                    <div class="mb-[var(--margin-form)] flex items-start justify-between flex-col">
                        <x-form_label for="details" class="mb-[var(--margin-label)]">Any other details?</x-form_label>
                        <textarea name="details" id="detail" class="text-[var(--black)] p-2 rounded-md w-full" placeholder="This also..."></textarea>
                    </div>
                    <div class="mb-[calc(var(--margin-form)_*_2)] flex items-start justify-between flex-col">
                        <x-form_label for="zipcode" class="mb-[var(--margin-label)]">Zipcode</x-form_label>
                        <select id="zipcode" name="zipcode" class="text-[var(--black)] p-2 rounded-md w-full">
